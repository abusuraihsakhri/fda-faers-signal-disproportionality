"""
FastAPI REST API Server for FAERS-Sentinel: PRR, ROR & Bayesian Information Component (IC) Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="FAERS-Sentinel: PRR, ROR & Bayesian Information Component (IC) Agent",
            description="Calculates Proportional Reporting Ratio (PRR), Reporting Odds Ratio (ROR), and Bayesian Confidence Propagation Neural Network IC.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "fda-faers-signal-disproportionality", "domain": "Pharmacovigilance", "version": "2.0.0-FRONTIER"}
