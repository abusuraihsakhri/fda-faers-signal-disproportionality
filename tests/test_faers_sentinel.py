...
import pytest
from faers_sentinel.models import FrontierPayload, ExecutionStatus
from faers_sentinel.engine import FrontierDomainEngine
from faers_sentinel.agents import DisproportionalityMatrixAgent, BayesianInformationComponentAgent, SignalThresholdEvaluatorAgent, FAERSSentinelCoordinator
from faers_sentinel.cli import main


def test_sub_agents():
    a1 = DisproportionalityMatrixAgent()
    ...
    a2 = BayesianInformationComponentAgent()
    ...
    a3 = SignalThresholdEvaluatorAgent()
...
def test_coordinator():
    coord = FAERSSentinelCoordinator()
    ...
    assert "WHO-UMC & FDA FAERS Signal Detection" in ans or "specifications" in ans
