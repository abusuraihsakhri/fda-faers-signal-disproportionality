"""
Automated Pytest for fda-faers-signal-disproportionality Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    FdafaerssignaldisproportionalityEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = FdafaerssignaldisproportionalityEnrichmentSuite()
